...
public class GPPURLHandler extends NSObject {
	...
	@Generated
	protected GPPURLHandler(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native GPPURLHandler alloc();
	...
	public static native boolean handleURLSourceApplicationAnnotation(
	...
	@Generated
	@Selector("init")
	public native GPPURLHandler init();
