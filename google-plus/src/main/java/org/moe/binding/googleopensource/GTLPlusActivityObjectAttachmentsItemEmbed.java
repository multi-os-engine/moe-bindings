...
@ObjCClassBinding
public class GTLPlusActivityObjectAttachmentsItemEmbed extends GTLObject {
	static {
		NatJ.register();
	}

	@Generated
	protected GTLPlusActivityObjectAttachmentsItemEmbed(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native GTLPlusActivityObjectAttachmentsItemEmbed alloc();
	...
	@Generated
	@Selector("init")
	public native GTLPlusActivityObjectAttachmentsItemEmbed init();
	...
	@Generated
	@Selector("object")
	public static native GTLPlusActivityObjectAttachmentsItemEmbed object_static();
	...
	public static native GTLPlusActivityObjectAttachmentsItemEmbed objectWithJSON(
