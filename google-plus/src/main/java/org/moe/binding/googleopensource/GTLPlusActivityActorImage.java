...
@ObjCClassBinding
public class GTLPlusActivityActorImage extends GTLObject {
	static {
		NatJ.register();
	}

	@Generated
	protected GTLPlusActivityActorImage(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native GTLPlusActivityActorImage alloc();
	...
	@Generated
	@Selector("init")
	public native GTLPlusActivityActorImage init();
	...
	@Generated
	@Selector("object")
	public static native GTLPlusActivityActorImage object_static();
	...
	public static native GTLPlusActivityActorImage objectWithJSON(
