...
@ObjCClassBinding
public class GTLPlusActivityObjectAttachmentsItemImage extends GTLObject {
	static {
		NatJ.register();
	}

	@Generated
	protected GTLPlusActivityObjectAttachmentsItemImage(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native GTLPlusActivityObjectAttachmentsItemImage alloc();
	...
	@Generated
	@Selector("init")
	public native GTLPlusActivityObjectAttachmentsItemImage init();
	...
	@Generated
	@Selector("object")
	public static native GTLPlusActivityObjectAttachmentsItemImage object_static();
	...
	public static native GTLPlusActivityObjectAttachmentsItemImage objectWithJSON(
