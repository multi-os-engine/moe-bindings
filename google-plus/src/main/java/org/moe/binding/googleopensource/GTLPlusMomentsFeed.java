...
@ObjCClassBinding
public class GTLPlusMomentsFeed extends GTLCollectionObject {
	static {
		NatJ.register();
	}

	@Generated
	protected GTLPlusMomentsFeed(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native GTLPlusMomentsFeed alloc();
	...
	@Generated
	@Selector("object")
	public static native GTLPlusMomentsFeed object_static();
	...
	public static native GTLPlusMomentsFeed objectWithJSON(
