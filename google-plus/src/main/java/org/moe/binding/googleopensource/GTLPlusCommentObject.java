...
@ObjCClassBinding
public class GTLPlusCommentObject extends GTLObject {
	static {
		NatJ.register();
	}

	@Generated
	protected GTLPlusCommentObject(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native GTLPlusCommentObject alloc();
	...
	@Generated
	@Selector("init")
	public native GTLPlusCommentObject init();
	...
	@Generated
	@Selector("object")
	public static native GTLPlusCommentObject object_static();
	...
	public static native GTLPlusCommentObject objectWithJSON(
