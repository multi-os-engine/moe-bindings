...
@ObjCClassBinding
public class GTLPlusPlacePosition extends GTLObject {
	static {
		NatJ.register();
	}

	@Generated
	protected GTLPlusPlacePosition(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native GTLPlusPlacePosition alloc();
	...
	@Generated
	@Selector("init")
	public native GTLPlusPlacePosition init();
	...
	@Generated
	@Selector("object")
	public static native GTLPlusPlacePosition object_static();
	...
	public static native GTLPlusPlacePosition objectWithJSON(
