...
@ObjCClassBinding
public class GTLPlusAclentryResource extends GTLObject {
	static {
		NatJ.register();
	}

	@Generated
	protected GTLPlusAclentryResource(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native GTLPlusAclentryResource alloc();
	...
	@Generated
	@Selector("init")
	public native GTLPlusAclentryResource init();
	...
	@Generated
	@Selector("object")
	public static native GTLPlusAclentryResource object_static();
	...
	public static native GTLPlusAclentryResource objectWithJSON(
