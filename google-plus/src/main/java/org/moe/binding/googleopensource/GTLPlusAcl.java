...
@ObjCClassBinding
public class GTLPlusAcl extends GTLCollectionObject {
	static {
		NatJ.register();
	}

	@Generated
	protected GTLPlusAcl(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native GTLPlusAcl alloc();
	...
	@Generated
	@Selector("object")
	public static native GTLPlusAcl object_static();
	...
	public static native GTLPlusAcl objectWithJSON(
