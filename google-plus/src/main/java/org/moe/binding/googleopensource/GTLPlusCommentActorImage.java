...
@ObjCClassBinding
public class GTLPlusCommentActorImage extends GTLObject {
	static {
		NatJ.register();
	}

	@Generated
	protected GTLPlusCommentActorImage(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native GTLPlusCommentActorImage alloc();
	...
	@Generated
	@Selector("init")
	public native GTLPlusCommentActorImage init();
	...
	@Generated
	@Selector("object")
	public static native GTLPlusCommentActorImage object_static();
	...
	public static native GTLPlusCommentActorImage objectWithJSON(
