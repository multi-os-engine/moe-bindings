...
@ObjCClassBinding
public class GTLPlusActivityObjectResharers extends GTLObject {
	static {
		NatJ.register();
	}

	@Generated
	protected GTLPlusActivityObjectResharers(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native GTLPlusActivityObjectResharers alloc();
	...
	@Generated
	@Selector("init")
	public native GTLPlusActivityObjectResharers init();
	...
	@Generated
	@Selector("object")
	public static native GTLPlusActivityObjectResharers object_static();
	...
	public static native GTLPlusActivityObjectResharers objectWithJSON(
