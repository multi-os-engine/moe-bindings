...
@ObjCClassBinding
public class GTLPlusActivityProvider extends GTLObject {
	static {
		NatJ.register();
	}

	@Generated
	protected GTLPlusActivityProvider(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native GTLPlusActivityProvider alloc();
	...
	@Generated
	@Selector("init")
	public native GTLPlusActivityProvider init();
	...
	@Generated
	@Selector("object")
	public static native GTLPlusActivityProvider object_static();
	...
	public static native GTLPlusActivityProvider objectWithJSON(
