...
@ObjCClassBinding
public class GTLPlusActivityObjectReplies extends GTLObject {
	static {
		NatJ.register();
	}

	@Generated
	protected GTLPlusActivityObjectReplies(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native GTLPlusActivityObjectReplies alloc();
	...
	@Generated
	@Selector("init")
	public native GTLPlusActivityObjectReplies init();
	...
	@Generated
	@Selector("object")
	public static native GTLPlusActivityObjectReplies object_static();
	...
	public static native GTLPlusActivityObjectReplies objectWithJSON(
