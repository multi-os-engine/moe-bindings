...
@ObjCClassBinding
public class GTLPlusActivityObjectActorImage extends GTLObject {
	static {
		NatJ.register();
	}

	@Generated
	protected GTLPlusActivityObjectActorImage(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native GTLPlusActivityObjectActorImage alloc();
	...
	@Generated
	@Selector("init")
	public native GTLPlusActivityObjectActorImage init();
	...
	@Generated
	@Selector("object")
	public static native GTLPlusActivityObjectActorImage object_static();
	...
	public static native GTLPlusActivityObjectActorImage objectWithJSON(
