...
@ObjCClassBinding
public class GTLPlusCommentPlusoners extends GTLObject {
	static {
		NatJ.register();
	}

	@Generated
	protected GTLPlusCommentPlusoners(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native GTLPlusCommentPlusoners alloc();
	...
	@Generated
	@Selector("init")
	public native GTLPlusCommentPlusoners init();
	...
	@Generated
	@Selector("object")
	public static native GTLPlusCommentPlusoners object_static();
	...
	public static native GTLPlusCommentPlusoners objectWithJSON(
