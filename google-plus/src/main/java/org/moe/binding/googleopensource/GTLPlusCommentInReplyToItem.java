...
@ObjCClassBinding
public class GTLPlusCommentInReplyToItem extends GTLObject {
	static {
		NatJ.register();
	}

	@Generated
	protected GTLPlusCommentInReplyToItem(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native GTLPlusCommentInReplyToItem alloc();
	...
	@Generated
	@Selector("init")
	public native GTLPlusCommentInReplyToItem init();
	...
	@Generated
	@Selector("object")
	public static native GTLPlusCommentInReplyToItem object_static();
	...
	public static native GTLPlusCommentInReplyToItem objectWithJSON(
