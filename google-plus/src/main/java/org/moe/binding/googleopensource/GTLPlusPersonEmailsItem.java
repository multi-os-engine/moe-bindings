...
@ObjCClassBinding
public class GTLPlusPersonEmailsItem extends GTLObject {
	static {
		NatJ.register();
	}

	@Generated
	protected GTLPlusPersonEmailsItem(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native GTLPlusPersonEmailsItem alloc();
	...
	@Generated
	@Selector("init")
	public native GTLPlusPersonEmailsItem init();
	...
	@Generated
	@Selector("object")
	public static native GTLPlusPersonEmailsItem object_static();
	...
	public static native GTLPlusPersonEmailsItem objectWithJSON(
