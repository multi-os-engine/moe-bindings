...
@ObjCClassBinding
public class GTLPlusPersonCoverCoverPhoto extends GTLObject {
	static {
		NatJ.register();
	}

	@Generated
	protected GTLPlusPersonCoverCoverPhoto(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native GTLPlusPersonCoverCoverPhoto alloc();
	...
	@Generated
	@Selector("init")
	public native GTLPlusPersonCoverCoverPhoto init();
	...
	@Generated
	@Selector("object")
	public static native GTLPlusPersonCoverCoverPhoto object_static();
	...
	public static native GTLPlusPersonCoverCoverPhoto objectWithJSON(
