...
@ObjCClassBinding
public class GTLPlusActivityActorName extends GTLObject {
	static {
		NatJ.register();
	}

	@Generated
	protected GTLPlusActivityActorName(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native GTLPlusActivityActorName alloc();
	...
	@Generated
	@Selector("init")
	public native GTLPlusActivityActorName init();
	...
	@Generated
	@Selector("object")
	public static native GTLPlusActivityActorName object_static();
	...
	public static native GTLPlusActivityActorName objectWithJSON(
