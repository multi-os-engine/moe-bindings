...
import org.moe.binding.mopub.protocol.MPInterstitialCustomEventDelegate;
...
public class MPInterstitialCustomEvent extends NSObject {
	...
	@Selector("delegate")
	@MappedReturn(ObjCObjectMapper.class)
	public native MPInterstitialCustomEventDelegate delegate();
	...
	public native void requestInterstitialWithCustomEventInfo(
			NSDictionary<?, ?> info);
	...
	public native void setDelegate_unsafe(
			@Mapped(ObjCObjectMapper.class) MPInterstitialCustomEventDelegate value);
