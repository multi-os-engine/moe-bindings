...
public class MPRewardedVideo extends NSObject {
	...
	@Generated
	@Selector("loadRewardedVideoAdWithAdUnitID:keywords:location:customerId:mediationSettings:")
	public static native void loadRewardedVideoAdWithAdUnitIDKeywordsLocationCustomerIdMediationSettings(
			String adUnitID, String keywords, CLLocation location,
			String customerId, NSArray<?> mediationSettings);

	@Generated
	@Selector("loadRewardedVideoAdWithAdUnitID:keywords:location:mediationSettings:")
	public static native void loadRewardedVideoAdWithAdUnitIDKeywordsLocationMediationSettings(
			String adUnitID, String keywords, CLLocation location,
